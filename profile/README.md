...
### [awesome-harness-rules](https://github.com/harnessclaw/awesome-harness-rules)

Community-curated rules and reusable configuration ideas for better Harnessclaw workflows.

### [homebrew-tap](https://github.com/harnessclaw/homebrew-tap)
...
- **Desktop app discussions**: [harnessclaw Discussions](https://github.com/harnessclaw/harnessclaw/discussions)
- **Engine discussions**: [harnessclaw-engine Discussions](https://github.com/harnessclaw/harnessclaw-engine/discussions)
- **Report issues**: [harnessclaw Issues](https://github.com/harnessclaw/harnessclaw/issues) · [harnessclaw-engine Issues](https://github.com/harnessclaw/harnessclaw-engine/issues)
- **Join the community**: [Discord](https://discord.gg/SeseGE7ZUH)
